...
for epoch in range(start_epoch, epochs):
    ...
    torch.save(model.prompt_learner.state_dict(), '/home/ths/zero-shot-clip/neural-motifs/prompt-ckpt/gqa/LAMM/prompt_learner_params_%d.pth' % epoch)
    model.eval()
    ...
    with open('/home/ths/zero-shot-clip/neural-motifs/result/GQA/LAMM/label_prompt_epoch'+str(epoch)+'.pickle', 'wb') as file:
